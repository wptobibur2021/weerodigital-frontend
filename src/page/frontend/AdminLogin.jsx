...
import { useLoginAdminMutation } from '../../feature/admin/adminSlice';
import { adminLogin } from '../../feature/admin/adminAPI';
...
const AdminLoginPage = () => {
    ...
    const onSubmit = (data) => {
        setIsLoad(true)
        adminLogin(loginAdmin, navigate, data, setIsLoad, dispatch)
    };
    return (
